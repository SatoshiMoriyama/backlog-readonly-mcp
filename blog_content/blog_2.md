...
BACKLOG_PROJECT_WHITELIST=MYPROJ,PROJ1,PROJ2,12345
```

カンマ区切りでプロジェクトキーと数値 ID を混在させて指定できます。`BACKLOG_DEFAULT_PROJECT` を設定している場合は、同じ表記でホワイトリストにも含めてください。
  ...
  "mcpServers": {
    "backlog-readonly": {
      ...
      "env": {
        ...
        "BACKLOG_API_KEY": "your-api-key-here",
        "BACKLOG_DEFAULT_PROJECT": "MYPROJ",
        "BACKLOG_PROJECT_WHITELIST": "MYPROJ,PROJ1,PROJ2"
      }
    }
  }
}
